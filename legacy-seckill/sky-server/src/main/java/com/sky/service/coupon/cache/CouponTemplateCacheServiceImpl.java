...
import com.sky.service.coupon.TemplateCacheService;
...
import static com.sky.constant.RedisKeyConstant.getCouponTemplateCacheKey;
 ...
 */
@Service
public class CouponTemplateCacheServiceImpl implements TemplateCacheService {
    ...
    //券模板信息拉取  每次服务启动时拉取
//    @PostConstruct
    protected void init() {         //CacheBuilder  guava缓存构建
        this.couponTemplateCache = CacheBuilder
                        .newBuilder()
                        .maximumSize(2 * 10000)
    ...
    private void loadAllCouponTemplateCache() {
        ...
        HashMap<String, CouponTemplate> couponTemplateHashMap =
                couponTemplateList
                        .stream()
