...
import com.sky.enumeration.ValidityTypeEnum;
...
import static com.sky.utils.CouponUtil.getCouponCode;
...
public class Coupon implements Serializable {
    ...
    //缓存击穿相关
    public Coupon(String couponCode,Date BeginTime) {
        this.code = couponCode;
        this.beginTime = BeginTime;
        this.couponTemplateCode="default";
    }
